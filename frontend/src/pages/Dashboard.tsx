            ...
            <div className="relative min-h-screen w-full flex flex-col items-center justify-center">
                <div className='flex gap-12 justify-center items-center'>
                    ...
                    <div className='hidden md:flex md:max-w-[500px] flex-col text-white gap-6'>
                        ...
                        <button className='button-bg rounded-[12px] w-[200px] h-[45px] self-center' onClick={goToChat}>Prenota con me</button>
                    </div>
                </div>
                <div className='md:hidden mt-8'>
                    <button className='text-white button-bg rounded-[12px] w-[200px] h-[55px]' onClick={goToChat}>Prenota con me</button>
                </div>
            </div>
        </>
    )
